...
document.querySelector('.btn-roll').addEventListener('click',function(){
  if(gameplay){
    ...
    var dice2=Math.floor(Math.random()*6+1);//new-code
     ...
     document.getElementById('dice-1').src='resources/img/dice-' + dice1 +'.png'; //new-code
     document.getElementById('dice-2').src='resources/img/dice-'+ dice2 +'.png'; //new-code
